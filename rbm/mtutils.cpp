...
// threadlog is seperated log file for each thread
ofstream threadlog;
...
// Initialize N_CPU and threadlog. NCore shows number of used core. -1 means all cores
// should be used. If NCore is greater than the number of current cores, N_CPU set as the
// current number of core.
